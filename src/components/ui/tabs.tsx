...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 items-center justify-center p-1 text-muted-foreground text-customSecondary",
      className
    )}
    {...props}
  />
